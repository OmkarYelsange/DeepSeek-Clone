  ...
  return (
    ...
    >
      <div>
        ...
        <div>
          <p className="my-1 text-gray-500">{expand ? "Recents" : ""}</p>
          {/* ChatLabel */}
      ...
      <div>
        ...
        >
          ...
          >
            <div className="relative w-max bd-black text-white text-sm p-3 rounded-lg shadow-lg">
        ...
        <div
          ...
          className={`flex items-center ${
            expand
              ? "hover:border-white/10 rounded-lg"
